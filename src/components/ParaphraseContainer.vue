<template>
  <div class="container mx-auto py-8 px-8">
    ...
    <textarea v-model="inputText"
      class="w-full h-40 p-4 border rounded-md resize-none dark:bg-gray-700 dark:border-gray-600 dark:text-white"
    ...
    <div v-if="isLoading" class="flex justify-center items-center" role="status">
...
<script>
import ParaphraseBox from "./ParaphraseBox.vue";
  ...
  methods: {
    async paraphrase() {
      try {
        ...
        const response = await apiService.paraphraseMulti(data);
